...
--------
  ...
  /qwen         — switch to Local Qwen3 Coder (Mac Mini) and restart gateway
...
---------------------------------------
  ...
  OPENCLAW_LOCAL_QWEN_MODEL   override /qwen,        default custom-192-168-86-45-11434/qwen3-coder-next
...
MODEL_REGISTRY = {
    ...
    # --- Local LLM on the LAN (Mac Mini, OpenAI-compatible custom provider, no API key) ---
    ...
    "qwen":        ("OPENCLAW_LOCAL_QWEN_MODEL",   "custom-192-168-86-45-11434/qwen3-coder-next", None, "custom-192-168-86-45-11434", "Local Qwen3 Coder (Mac Mini)"),
}
...
def cmd_help(token: str, chat_id: str) -> None:
    send(token, chat_id,
         ...
         "/qwen — Local Qwen3 Coder (Mac Mini) + restart\n"
...
MENU_COMMANDS = [
    ...
    ("qwen",        "Switch to Local Qwen3 Coder (Mac Mini)"),
    ("codex_reauth", "Start remote phone-first Codex OAuth re-auth"),
    # Integrations
    ("garmin",       "Manually trigger the Garmin poller"),
...
COMMANDS = {
    ...
    "/qwen":         lambda t, c: cmd_switch(t, c, "qwen"),
