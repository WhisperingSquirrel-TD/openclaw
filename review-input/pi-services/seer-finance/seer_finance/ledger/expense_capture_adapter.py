...
DEFAULT_DATABASE = Path('/home/tomdean88/pi-services/seer-finance/data/expense-ledger.sqlite3')
DEFAULT_REPLAY = Path('/home/tomdean88/.openclaw/runtime/inbound-watch-router/expense-sqlite-replay.json')
