...
STATE_DIR = ROOT / 'pi-services' / 'expense-intake-watcher'
STATE_FILE = STATE_DIR / 'state.json'
LOG_FILE = STATE_DIR / 'watcher.log'
EXPENSE_FILE = WORKSPACE / 'seer-expenses.md'
MS_READER = ROOT / 'pi-services' / 'trusted-email-reader' / 'read_email.py'
GMAIL_READER = ROOT / 'pi-services' / 'trusted-email-reader' / 'read_gmail.py'
