---
name: app-init
description: Initialize an approved app project by creating its repository, scaffolding the standard template, storing the canonical link, and preparing the hosted preview path.
---
