...
// gpt-5.5 is OpenAI's newest GPT-5-series model (available via API key and Codex
// ChatGPT sign-in) and is not yet in pi-ai's built-in catalog. Resolve it via the
