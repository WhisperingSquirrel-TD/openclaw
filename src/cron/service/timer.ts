...
function emitJobFinished(
  ...
  emit(state, {
    ...
    nextRunAtMs: job.state.nextRunAtMs,
    governedSkill: result.governedSkill,
    governanceStatus: result.governanceStatus,
    governanceBlockedReason: result.governanceBlockedReason,
    governanceReceiptId: result.governanceReceiptId,
    governanceVersionId: result.governanceVersionId,
    governanceContentSha256: result.governanceContentSha256,
    governanceWorkflowSource: result.governanceWorkflowSource,
    governanceResourceId: result.governanceResourceId,
    governanceWorkflowSha256: result.governanceWorkflowSha256,
    governanceProofOutcome: result.governanceProofOutcome,
    model: result.model,
    provider: result.provider,
    usage: result.usage,
  });
